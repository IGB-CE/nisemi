...
import { supabase, CAR_PHOTOS_BUCKET, DRIVER_DOCS_BUCKET } from './supabase.js';
import { sendPushNotifications } from './push.js';

/**
 * Permanently delete a user's account. We keep the User row but strip every
 * piece of personal data and destroy all login paths (one-way anonymize),
 ...
 *
 * Used both for self-service deletion (DELETE /users/me) and admin-initiated
 * deletion of accounts that violate the rules.
 */
