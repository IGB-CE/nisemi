...
import passengerRatingsRouter from './routes/passenger-ratings.js';
...
app.get('/health', (_req, res) => res.json({ status: 'ok', service: 'nisemi-api' }));
...
app.use('/api/v1/passenger-ratings', passengerRatingsRouter);
